...
namespace AppCore.Application.Helpers
{
    public static class helper
    {
        ...
        // public static List<A0002> ListUsers = new List<A0002>();
        ...
        public static void ResizeImage(string filePath, int maxWidth, int maxHeight, int quality)
        {
            ...
            System.Drawing.Image image = System.Drawing.Image.FromFile(filePath + "old");
            File.Delete(filePath);
            int originalWidth = image.Width;
            int originalHeight = image.Height;
        ...
        //                A0011 wa = new A0011();
        //                wa.A0011_ID = GenKey();
        //                wa.thietBiTruyCap = getDecideNameAuto(rq.UserAgent);
        //                try
        //                {
        //                    wa.IPTruyCap = (rq.ServerVariables["HTTP_X_FORWARDED_FOR"] ?? rq.ServerVariables["REMOTE_ADDR"]).Split(',')[0].Trim();
        //                }
        //                catch { wa.IPTruyCap = ""; }
        ...
        //public static void saveLog_IP(HttpRequestBase rq, string Users_ID, string hoVaTen, string title, string controller, string content, int IsType)
        //{
        //    Task.Factory.StartNew(() =>
        //    {
        //        using (MeikoEntities db = new MeikoEntities())
        ...
        //                var obj = new A0012();
        //                obj.A0012_ID = GenKey();
        //                obj.A0002_ID = Users_ID;
        //                obj.tieuDe = title;
        //                obj.controller = controller;
        //                obj.logDate = DateTime.Now;
        //                obj.logContent = content;
        //                obj.hoVaTen = hoVaTen;
        //                obj.kieuDuLieu = IsType;
        //                string Device = getDecideNameAuto(rq.UserAgent);
        //                try
        //                {
        //                    obj.IPTruyCap = (rq.ServerVariables["HTTP_X_FORWARDED_FOR"] ?? rq.ServerVariables["REMOTE_ADDR"]).Split(',')[0].Trim();
        //                }
        //                catch
        //                {
        //                    obj.IPTruyCap = "";
        //                }
        //                obj.thietBiTruyCap = Device;
        //                db.A0012.Add(obj);
        //                db.SaveChanges();
        //            }
        //            catch { }
        ...
        //        Task.Factory.StartNew(() =>
        //        {
        //            using (osEntities db = new osEntities())
        //            {
        //                try
        //                {
        //                    db.Configuration.LazyLoadingEnabled = false;
        ...
        //public static void SendNotification(List<string> ids, string ct, string name, string dd)
        //{
        //    OneSignalClient client = new OneSignalClient(
        //    "3fa55af7-ab21-448b-9058-8ebc4d7c812c",
        //    "MWJlOWVkNjMtNGNmNi00NzViLTgwZGYtYTRmZGI0YjgzMzg0",
        //    "Nzg4ZTE4MGUtZjNiZi00NGVmLWE5ZGYtNDFmOTE4Y2VkZWVk");
        //    Dictionary<string, string> contentMsgs = new Dictionary<string, string>();
        //    Dictionary<string, string> heads = new Dictionary<string, string>();
        //    Attachment atm = new Attachment();
        //    if (dd.IndexOf("http") == -1 && dd.IndexOf("http") == -1)
        //    {
        //        dd = "http://192.168.1.5:5000/" + dd;
        //    }
        ...
        //        imgs.Add("id", dd);
        //        atm.ios_attachments = imgs;
        //    }
        //    heads.Add("en", name);
        //    heads.Add("vi", name);
        //    contentMsgs.Add("en", ct);
        //    contentMsgs.Add("vi", ct);
        //    ContentAndLanguage content = new ContentAndLanguage(contentMsgs, heads, null, false);
        //    Device dv = new Device(new HashSet<string>(ids));
        //    client.SendNotification(dv, content, atm, null);
        //}
        //#endregion
